...
public class GameFrame extends JFrame {
	...
	public GameFrame() {
		...
		Image imgTemp = imgJ.getImage().getScaledInstance(imgJ.getIconWidth()/2, imgJ.getIconHeight()/2, java.awt.Image.SCALE_SMOOTH);
		...
		JLabel lblLogs = new JLabel("Logs: This shows the most recent action taken for better clarity and debug purposes");
